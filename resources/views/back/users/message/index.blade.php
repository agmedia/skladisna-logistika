            ...
            <div class="block-content">
                <table class="table table-hover table-vcenter">
                    ...
                    <tr>
                        ...
                        <th class="text-center" style="width: 24%;">Datum</th>
                        <th style="width: 15%;">Od</th>
                        <th style="width: 15%;">Prema</th>
                        <th>Subject</th>
                    ...
                    @foreach($messages as $key => $message)
                        <tr>
                            ...
                            <td class="text-center">
                                <span class="badge badge-pill badge-light">{{ date_format(date_create($message->created_at), 'd.m.Y. H:i') }}</span>
                            </td>
