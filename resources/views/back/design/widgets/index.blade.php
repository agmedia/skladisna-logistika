        ...
        <h2 class="content-heading">Widgets
            <small>
                ...
                <span class="float-right">
                    <a href="{{ route('widget.create') }}" class="btn btn-sm btn-secondary ml-30" data-toggle="tooltip" title="Novi Widget">
                    ...
                    <div class="col-12 col-md-3">
                        <select class="js-select2 form-control form-control-sm" id="group-select" style="width: 100%;">
                            ...
                            @foreach ($groups as $group)
                                <option value="{{ $group->group }}" {{ $group->group == request()->input('group') ? 'selected="selected"' : '' }}>{{ strtoupper($group->group) }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <table class="table table-hover table-vcenter">
                    ...
                    @foreach($widgets as $key => $widget)
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $widget->group }}</td>
