                        ...
                        <div class="entry clearfix">
                            ...
                            <div class="entry-c">
                                ...
                                <div class="entry-content">
                                    ...
                                    @if (isset($blog->subcat))
                                        <a href="{{ route('blogovi', ['cat' => $blog->cat->slug, 'subcat' => $blog->subcat->slug, 'blog' => $blog->slug]) }}" class="more-link">Opširnije</a>
                                    @else
                                        <a href="{{ route('blogovi', ['cat' => $blog->cat->slug, 'subcat' => $blog->slug]) }}" class="more-link">Opširnije</a>
                                    @endif
                                </div>
                            </div>
                        </div>
