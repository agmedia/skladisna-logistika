                    ...
                    @foreach($payments as $key => $payment)
                        ...
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell text-right">
                                ...
                                <button type="button" class="btn btn-sm btn-circle btn-alt-danger ml-2" data-toggle="tooltip" title="Obriši" onclick="event.preventDefault(); shouldDeleteItem({{ json_encode($payment) }});">
...
@push('js_after')
    ...
    <script>
        ...
        function deleteItem(item) {
            axios.post("{{ route('payment.destroy') }}", {data: item})
            .then(r => {
                if (r.data) {
                    location.reload()
                }
