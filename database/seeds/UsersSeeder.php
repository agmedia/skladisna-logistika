    ...
    public function run()
    {
        ...
        DB::insert(
            "INSERT INTO `user_details` (`user_id`, `fname`, `lname`, `address`, `zip`, `city`, `avatar`, `bio`, `social`, `role`, `status`, `created_at`, `updated_at`) VALUES
              (1, 'Filip', 'Jankoski', 'Kovačića 23', '44320', 'Kutina', 'images/avatars/default_avatar.jpg', 'Lorem ipsum...', '790117367', 'admin', 1, NOW(), NOW()),
              (2, 'Tomislav', 'Jureša', 'Malešnica bb', '10000', 'Zagreb', 'images/avatars/default_avatar.jpg', 'Lorem ipsum...', '', 'admin', 1, NOW(), NOW())"
        );
    }
}
