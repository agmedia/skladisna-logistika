                    ...
                    <table class="table cart">
                        ...
                        <tr class="cart_item" v-for="item in $store.state.cart.items">
                            ...
                            <td class="cart-product-name">
                                ...
                                <div class="row" style="margin: 5px 0px;">
                                    ...
                                    <div class="col-xs-9" style="width: 67%;">
                        ...
                        <tr class="empty">
                            <td colspan="2">
                                <div class="row">
                                    <div class="col-lg-12 p-0">
                                        <input type="text" v-model="coupon" placeholder="Upišite kupon" class="sm-form-control" style="width: 48%; display: inline;">
                                        <span>
                                            <a @click.prevent="checkCoupon()" class="btn button-border" style="margin-left: 10px; width: 45%;">Koristi Kupon</a>
                                        </span>
                                    </div>
                                </div>
                            </td>
