                ...
                <div class="block-content">
                    <div class="row items-push">
                        <div class="col-lg-7">
                            ...
                            <hr class="mb-30">
                            <div class="block {{ isset($category) && isset($category->image) ? '' : 'block-mode-hidden' }}">
                                <div class="block-header block-header-default" style="border: 1px solid #e9e9e9;">
                                    <h3 class="block-title">Glavna Fotografija Kategorije</h3>
                                    ...
                                    <div class="row">
                                        <dov class="col-md-6 offset-md-3">
                                            <div class="slim"
                                                ...
                                                <img src="{{ isset($category) && isset($category->image) ? asset($category->image) : '' }}" alt=""/>
                            ...
                            <div class="form-group mb-30">
                                ...
                                <textarea class="form-control" name="meta_description" id="category-meta-description" rows="4" placeholder="Kratki SEO opis kategorije..." onkeyup="SetSEOPreview()">{{ isset($category) ? $category->meta_description : '' }}</textarea>
                            </div>
                            <div class="form-group mb-50">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="block">
                                <div class="block-content" style="background-color: #f8f9f9; border: 1px solid #e9e9e9; padding: 30px;">
                                    <div class="form-group mb-30" id="group-category-select">
                                    ...
                                    <div class="form-group mb-30" id="parent-category-select">
