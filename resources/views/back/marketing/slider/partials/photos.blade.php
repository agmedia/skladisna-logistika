...
<div id="slider_container">
    <div class="row">
        <div class="col-3">
            <h5 class="text-black mb-0 mt-20">Slider Slike i Poruka</h5>
        </div>
    ...
    <div class="row items-push">
        <div class="col-lg-3">
            <p class="text-muted">Dodajte lijepe fotografije kojima ćete se predstaviti svojim kupcima...</p>
        </div>
                            ...
                            <div class="options-container fx-item-zoom-in fx-overlay-zoom-out">
                                ...
                                <div class="options-overlay bg-primary-dark-op">
                                    <div class="options-overlay-content">
                                        <h3 class="h4 text-white mb-5">Fotografija</h3>
                                        <h4 class="h6 text-white-op mb-15">Više detalja</h4>
...
@push('slider_scripts')
    ...
    <script>
      ...
      let productDropzone = new Dropzone("#slider_container", {
