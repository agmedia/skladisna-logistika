...
@section('content')
    ...
    <div class="bg-image" style="background-image: url({{ asset('/media/images/toyota-admin.jpg') }});">
            ...
            <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                <div class="p-30 invisible" data-toggle="appear">
                    ...
                    <p class="font-italic text-white-op">
                        &copy; <span class="js-year-copy">2020</span>. Sva prava pridržana. Skladišna Logistika d.o.o.
                    </p>
                </div>
            </div>
            <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                <div class="content content-full">
                    ...
                    <div class="px-30 py-10">
                        <img height="80" src="{{ asset('images/logo.svg') }}" alt="{{ config('app.name') }}" />
                   ...
                   {{--     <div class="block block-bordered mt-50">
                            <div class="block-content block-content-full">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('login.as', ['role' => 'customer']) }}">Customer</a>
                                </div>
                            </div>
                        </div>--}}
